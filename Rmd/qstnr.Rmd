...
-   Figure out whether it would be feasible to generate the key hierarchy tree(s) directly from the JSON schemas.
...
TODO: read from `data-raw/json_schemas/schemas/subschemas/qstnr-item-value_scale.schema.json` schema
